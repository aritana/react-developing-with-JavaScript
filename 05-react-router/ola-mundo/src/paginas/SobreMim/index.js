...
export default function SobreMim() {
  return (
    <PostModelo fotoCapa={fotoCapa} titulo="Sobre mim">
      <h3 className={styles.subtitulo}>Olá, eu so ou Aritana Noara.</h3>
      <img
        src={fotoSobreMim}
      ...
      <p className={styles.paragrafo}>
        Programar é divertido, é uma arte que proporciona o prazer de dar à luz novas coisas, é ajudar as pessoas
